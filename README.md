...
Some things to note in the following manifest:
 ...
 - The manifest code generated by flatpak-opam-generator for `lablgtk` [&#8629;](https://github.com/josecastillolema/flatpak-ocaml-examples/blob/main/flatpak.ocaml.lablgtk.yaml#L29-L46)
